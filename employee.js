...
// Ensure SweetAlert2 is loaded in your HTML file before using Swal.fire
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  createEmployeeForm.addEventListener('submit', async (e) => {
      ...
      const employeeData = { fullname: fullName, email, username, password, confirmPassword };
...
// Load profile data including recommendations
